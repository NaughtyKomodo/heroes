            ...
            <div class="row mt-5">
                <div class="col-md-4 mb-3">
                    <div class="highlighted-kategori kategori-terlaris1 d-flex justify-content-center align-items-center">
                        <h4 class="text-white">
                            <a class="no-decoration" href="produk.php?kategori=Mechanical">Mechanical</a>
                        </h4>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="highlighted-kategori kategori-terlaris2 d-flex justify-content-center align-items-center">
                        <h4 class="text-white">
                            <a class="no-decoration" href="produk.php?kategori=Magnetic">Magnetic</a>
                        </h4>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="highlighted-kategori kategori-terlaris3 d-flex justify-content-center align-items-center">
                        <h4 class="text-white">
                            <a class="no-decoration" href="produk.php?kategori=Keycaps">Keycaps</a>
                        </h4>
                    </div>
                </div>
            </div>
